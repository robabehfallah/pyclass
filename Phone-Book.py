...
window = Tk()
window.title("Green Contact Book")
...
Label(window, text='CONTACT BOOK', font=("Noto Sans CJK TC", 15, "bold"), bg='green', fg='White').pack(side=TOP, fill=X)
...
right_frame = Frame(window, bg=rf_bg)
